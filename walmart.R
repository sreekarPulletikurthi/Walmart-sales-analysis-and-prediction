getwd()
library(readxl)
Walmart <- read_excel("Walmart.xlsx")
View(Walmart)
data1 <- Walmart
...
data2$month_Year = substr(data2$Date, 1, 7)

View(data2)

#Subsetting Q3-2012 data (i.e, 07-2012,08-2012,09-2012), Q2-2012 data (i.e, 04-2012,05- 2012,06-2012)
Q3_2012 <- filter(data2,month_Year == "2012-07" | month_Year== "2012-08" | month_Year== "2012-09")
View(Q3_2012)
Q2_2012 <- filter(data2,month_Year == "2012-04" | month_Year== "2012-05" | month_Year== "2012-06")
View(Q2_2012)
...
weekly_sales$Date <-as.Date(weekly_sales$Date, "%Y-%m-%d")
